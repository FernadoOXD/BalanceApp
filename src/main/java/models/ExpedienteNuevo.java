...
public class ExpedienteNuevo {
    ...
    private String fechaInicializacion;
    private String notasInternas;

    // Constructores vacíos y con parámetros (si usas)
    ...
    public String getPatologiaPrevia() { return patologiaPrevia; }
    public void setPatologiaPrevia(String patologiaPrevia) { this.patologiaPrevia = patologiaPrevia; }

    public String getAlergiaIntolerancia() { return alergiaIntolerancia; }
    public void setAlergiaIntolerancia(String alergiaIntolerancia) { this.alergiaIntolerancia = alergiaIntolerancia; }
    ...
    public String getHabitoToxico() { return habitoToxico; }
    public void setHabitoToxico(String habitoToxico) { this.habitoToxico = habitoToxico; }

    public String getFechaInicializacion() { return fechaInicializacion; }
    public void setFechaInicializacion(String fechaInicializacion) { this.fechaInicializacion = fechaInicializacion; }
